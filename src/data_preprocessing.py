...
def transform_text(text):
    """
    Transforms the input text by lowercasing, tokenizing, removing stopwords and punctuation, and stemming.
    Args:
...
def preprocess_df(df, text_column='text', target_column='target'):
    ...
    Args:
        ...
        text_column (str): The name of the text column to transform.
